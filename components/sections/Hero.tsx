        ...
        <div className="mx-auto grid max-w-6xl lg:grid-cols-2">
          ...
          <div className="flex flex-col items-center justify-center gap-3 p-5 text-white lg:items-start">
            ...
            <p>
              ...
              abilities of your favorite ninjas. Whether you're a long-time fan
              or new to the series, delve into the epic adventures of Naruto and
              his comrades as they navigate the challenges of the ninja world.
